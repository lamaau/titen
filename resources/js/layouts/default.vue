  ...
  <div :class="{ dark: dark }">
    ...
    >
      ...
      >
        ...
        <footer
          class="flex shrink-0 items-center gap-3 border-t px-6 py-3 dark:border-none"
        >
          <div
          ...
          <div>
            ...
            <p
              class="text-xs text-gray-500 hover:text-gray-700 focus:text-gray-700 dark:text-gray-300"
            >
                ...
                <div class="flex items-center">
                  <button @click.prevent="toggleTheme" type="button">
                    ...
                    <v-icon
                      v-else
                      name="SunIcon"
                      class="h-6 w-6 dark:text-purple-200"
                      type="outline"
                    />
                  </button>
                </div>
