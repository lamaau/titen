<template>
  ...
  <div :class="{ dark: dark }">
    <div class="flex min-h-screen w-full bg-gray-50 text-gray-700 dark:bg-cool-gray-600">
      <aside ref="sidebar" class="fixed inset-y-0 left-0 z-20 hidden h-screen w-[14rem] translate-x-0 flex-col overflow-hidden shadow-2xl duration-300 lg:z-0 lg:flex lg:translate-x-0">
        <header class="flex h-[4rem] shrink-0 items-center border-b px-6 dark:border-none dark:bg-cool-gray-800">
          <v-app-link class="mx-auto text-xl font-bold tracking-tight dark:text-gray-200" href="/"> TITEN APP </v-app-link>
        </header>
